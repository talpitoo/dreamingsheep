...
<head prefix="og: http://ogp.me/ns#">
  <meta charset="utf-8">
  <title>dreamingsheep</title>
  <meta name="description" content="Long time, no sleep?">
  <meta name="author" content="@talpitoo">
  <meta name="viewport" content="width=device-width,initial-scale=1">

  <meta property="og:title" content="dreamingsheep">
  <meta property="og:description" content="Long time, no sleep?">
  <meta property="og:type" content="website">
  <meta property="og:url" content="http://dreamingsheep.net/">
  <meta property="og:image" content="http://dreamingsheep.net/images/cover1200x630.jpg?ver=16082017">
  <meta name="twitter:card" content="summary">
  <meta name="twitter:site" content="@talpitoo">
  <meta name="twitter:creator" content="@talpitoo">
  <meta name="twitter:title" content="dreamingsheep">
  <meta name="twitter:description" content="Long time, no sleep?">

  <meta name="apple-mobile-web-app-capable" content="yes">
  <meta name="mobile-web-app-capable" content="yes">

  <meta name="application-name" content="dreamingsheep">
  <meta name="msapplication-TileColor" content="#ffffff">
  <meta name="msapplication-square70x70logo" content="images/cover70x70.png">
  <meta name="msapplication-square150x150logo" content="images/cover150x150.png">
  <meta name="msapplication-wide310x150logo" content="images/cover310x150.png">
  <meta name="msapplication-square310x310logo" content="images/cover310x310.png">

  <link rel="apple-touch-icon" sizes="152x152" href="images/apple-touch-icon-152-precomposed.png">
  <link rel="apple-touch-icon" sizes="144x144" href="images/apple-touch-icon-144-precomposed.png">
  <link rel="apple-touch-icon" sizes="120x120" href="images/apple-touch-icon-120-precomposed.png">
  <link rel="apple-touch-icon" sizes="114x114" href="images/apple-touch-icon-114-precomposed.png">
  <link rel="apple-touch-icon" sizes="76x76" href="images/apple-touch-icon-76-precomposed.png">
  <link rel="apple-touch-icon" sizes="72x72" href="images/apple-touch-icon-72-precomposed.png">
  <link rel="apple-touch-icon" sizes="60x60" href="images/apple-touch-icon-60-precomposed.png">
  <link rel="apple-touch-icon" sizes="57x57" href="images/apple-touch-icon-57-precomposed.png">

  <link rel="icon" sizes="196x196" href="images/cover196x196.png" type="image/png">
  <link rel="icon" sizes="160x160" href="images/cover160x160.png" type="image/png">
  <link rel="icon" sizes="96x96" href="images/cover96x96.png" type="image/png">
  <link rel="icon" sizes="32x32" href="images/cover32x32.png" type="image/png">
  <link rel="shortcut icon" sizes="16x16" href="favicon.ico">

  <link rel="stylesheet" href="styles/landing.css">

  <link rel="prefetch" href="images/sheep-mail.png">
</head>
    ...
    <div class="row">
      <div class="col-md-4 col-md-offset-4 text-center">
        <?php if(isset($_POST['emailAddress'])): ?>
          <img src="images/sheep-mail.png" alt="dreamingsheep" width="325" height="325">
        <?php else: ?>
          <img src="images/sheep-dreamingsheep.png" alt="dreamingsheep" width="325" height="325">
        <?php endif; ?>
        <h1 class="text-hide text-dreamingsheep">dreamingsheep</h1>
      </div>
    </div>
    <div class="row featured">
      <div class="col-md-12">
        <div class="panel panel-default stripe visible-lg">
          <div class="panel-body">
            <p>Bearing all the aforementioned dialogues we discover the possibilities of
...
(x3) Unproductive thinking. &copy; David Lynch - Strange and unproductive thinking</p>
<button class="btn btn-primary btn-lg portfolio-next">Next &raquo;</button>
          </div>
        </div>
        <div class="nexus10">
          <div class="screen-tablet">
            <img src="images/tablet-dreamingsheep@2x.jpg" alt="Preview on a tablet" class="portfolio-tablet" />
            <!-- srcset="images/tablet-dreamingsheep.jpg 1x, images/tablet-dreamingsheep@2x.jpg 2x" -->
          </div>
          <div class="nexus5">
            <div class="screen-smartphone">
              <img src="images/smartphone-dreamingsheep@2x.jpg" alt="Preview on a smartphone" class="portfolio-smartphone" />
              <!-- srcset="images/smartphone-dreamingsheep.jpg 1x, images/smartphone-dreamingsheep@2x.jpg 2x" -->
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="row">
      <div class="col-md-4 col-md-offset-4 text-center">
        <div class="panel panel-default text-left">
          <div class="panel-body">
            <?php if(isset($_POST['emailAddress'])): ?>
              <p>Thank you, we will notify you once we launch. <strong>Sweet dreams!</strong></p>
            <?php else: ?>
              <p>A place for your dreams.</p>
              <form method="post">
                <div class="form-group">
                  <label class="sr-only" for="emailAddress">Email:</label>
                  <input name="emailAddress" id="emailAddress" type="email" class="form-control input-lg" placeholder="Email" required>
                </div>
                <button class="btn btn-primary btn-block btn-lg" type="submit">Notify meh</button>
              </form>
            <?php endif; ?>
            <?php
              if (isset($_POST['emailAddress'])) {
                ...
                // MySQL connection
                $con=mysqli_connect("mysql579.loopia.se","pasztor@d39088","eberbirkapasztor","dreamingsheep_net");
                // Check connection
                ...
                mysqli_query($con,"INSERT INTO notify (email) VALUES ('$emailAddress')");
        ...
        <p class="text-slogan">Long time, no sleep?</p>
      </div>
    </div>
  </div>
  <script>
  ...
  <script>
    $(function() {
      ...
      $('.featured').removeClass().addClass('featured dreams-01');
      $('.nexus5, .portfolio-next').on('click', function() {
        if ($('.featured').hasClass('dreams-01')) {
          $('.featured').removeClass('blank dreams-01').addClass('dreams-02');
        } else if ($('.featured').hasClass('dreams-02')) {
          $('.featured').removeClass('blank dreams-02').addClass('symbols');
        } else if ($('.featured').hasClass('symbols')) {
          $('.featured').removeClass('blank symbols').addClass('stats');
        } else if ($('.featured').hasClass('stats')) {
          $('.featured').removeClass('blank stats').addClass('dreams-01');
        } else {
          $('.featured').removeClass('blank dreams-01').addClass('dreams-02');
        }
