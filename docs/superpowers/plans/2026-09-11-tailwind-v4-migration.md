...
| `transformOrigin/transform/mb` computed from a measured width (`SymbolsRadioList.tsx:108`)                                                                                                                                                                           | `style={{ transformOrigin: "top center", transform: …, marginBottom: … }}` — genuinely dynamic numbers; the only sanctioned `style` prop.                                                                     |
